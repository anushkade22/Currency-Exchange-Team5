        ...
        <form className="Auth-form">
          <div className="Auth-form-content">
            ...
            <div className="d-grid gap-2 mt-3">
              <button type="submit" className="btn btn-primary"style={{fontSize: 25}} >
                Submit
              </button>
            </div>
            <p className="text-center mt-2" style={{fontSize: 25}}>
              Forgot <a href="#" style={{fontSize: 25}}>password?</a>
            </p>
          </div>
        </form>
      </div>
    ...
    <div className="Auth-form-container">
      <form className="Auth-form">
        <div className="Auth-form-content">
          ...
          <div className="form-group mt-3">
            <label style={{fontSize: 20}}>Contact Number</label>
            <input
              type=""
              className="form-control mt-1"
          ...
          <p className="text-center mt-2" style={{fontSize: 20}}>
            Forgot <a href="#" style={{fontSize: 20}}>password?</a>
          </p>
        </div>
      </form>
    </div>
